...
export class SuggestionController {
    ...
    async createSuggestions(req: Request, res: Response) {
        ...
        try {
            if (!req.user) {
                Logger.warn('SuggestionController', 'createSuggestions - User not authenticated');
            ...
            Logger.debug('SuggestionController', 'createSuggestions - Saving suggestion to database', { userId, task });
